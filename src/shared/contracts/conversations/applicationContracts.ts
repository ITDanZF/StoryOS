import type { ChapterGenerationEvent } from "../books/chapterGenerationEvents.ts";
import type { NovelMutation } from "../books/novelEvents.ts";
...
export type RunStatus = "running" | "cancelling" | "completed" | "aborted" | "timed_out" | "failed";
