...
import type { SerializableTaskFailure } from "../../engine/taskFailure.ts";
...
export type ConversationEventBase<TType extends string, TPayload> = {
...
export type AssistantBlockEventBase<TType extends string, TPayload> = ConversationEventBase<
  TType,
  TPayload
> & {
