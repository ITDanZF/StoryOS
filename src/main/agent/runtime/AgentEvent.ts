import type { ToolExecutionEvent } from "../tools/security/GuardedTool.ts";
import type { ExecutionContext } from "./ExecutionContext.ts";

export type AgentEventSource = Pick<ExecutionContext, "runId" | "agentType">;
...
export function createAgentEvent(source: AgentEventSource, payload: AgentEventPayload): AgentEvent {
