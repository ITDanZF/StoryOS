...
import type { ChapterStatus, NovelStatus } from "../../../../shared/contracts/books/novelPorts.ts";
export type { ChapterStatus, NovelStatus } from "../../../../shared/contracts/books/novelPorts.ts";
...
export interface ChapterRevisionWriter {
  saveRevision(
...
export interface BookStructureWriter {
...
export interface NovelPersistence
  extends
    ChapterDraftStore,
    ChapterRevisionWriter,
    ChapterRevisionReader,
    BookStructureReader,
    BookStructureWriter {}
