...
import type { ProjectLocationType } from "../../../shared/contracts/projects/ProjectLayout.ts";
import { getCustomizeWorkSpace, getDefaultWorkSpace } from "./path.ts";
export type { ProjectLocationType } from "../../../shared/contracts/projects/ProjectLayout.ts";
