  ...
  const replaceText = tool(
    ...
    },
    {
      ...
      schema: z.object({
        ...
        replacement_text: z
          .string()
          .describe("Replacement plain text. Use an empty string to delete the expected text."),
        occurrence: z
          .number()
          .int()
          .positive()
          .optional()
          .describe("1-based occurrence to replace when expected_text appears more than once."),
        replace_all: z
          .boolean()
          .optional()
          .default(false)
    ...
    },
    {
      ...
      schema: z.object({
        ...
        expected_current_text: z
          .string()
          .describe("Exact full persisted plain text returned by read_book_chapter."),
