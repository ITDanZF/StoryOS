...
const agentApi: AgentDesktopApi & OutlineDesktopApi = {
  ...
  testEmbedding: (request) =>
    ipcRenderer.invoke(AGENT_IPC_CHANNELS.testEmbedding, request),
  sendMessage: (request) =>
  ...
  cancelConversationRun: (scope, runId) =>
    ipcRenderer.invoke(AGENT_IPC_CHANNELS.cancelConversationRun, scope, runId),
  ...
  commitBookshelfBookImport: (request) =>
    ipcRenderer.invoke(AGENT_IPC_CHANNELS.commitBookshelfBookImport, request),
  cancelBookshelfBookImport: (sessionId) =>
    ipcRenderer.invoke(AGENT_IPC_CHANNELS.cancelBookshelfBookImport, sessionId),
  prepareBookshelfBookExport: (request) =>
    ipcRenderer.invoke(AGENT_IPC_CHANNELS.prepareBookshelfBookExport, request),
  commitBookshelfBookExport: (request) =>
