...
const agentApi: AgentDesktopApi = {
    ...
    getBookshelfBooks: () => ipcRenderer.invoke(AGENT_IPC_CHANNELS.bookshelfBooks),
    createBookshelfBook: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.createBookshelfBook, request),
    importBookshelfBook: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.importBookshelfBook, request),
    exportBookshelfBook: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.exportBookshelfBook, request),
    getBookTransferFormats: () => ipcRenderer.invoke(AGENT_IPC_CHANNELS.bookTransferFormats),
    prepareBookshelfBookImport: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.prepareBookshelfBookImport, request),
    commitBookshelfBookImport: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.commitBookshelfBookImport, request),
    cancelBookshelfBookImport: (sessionId) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.cancelBookshelfBookImport, sessionId),
    prepareBookshelfBookExport: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.prepareBookshelfBookExport, request),
    commitBookshelfBookExport: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.commitBookshelfBookExport, request),
    cancelBookshelfBookExport: (exportId) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.cancelBookshelfBookExport, exportId),
    getBookshelfTrash: () => ipcRenderer.invoke(AGENT_IPC_CHANNELS.bookshelfTrash),
    moveBookshelfBookToTrash: (bookId) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.moveBookshelfBookToTrash, bookId),
    restoreBookshelfBookFromTrash: (bookId) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.restoreBookshelfBookFromTrash, bookId),
    permanentlyDeleteBookshelfBook: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.permanentlyDeleteBookshelfBook, request),
    getBookProjectArchives: (bookId) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.bookProjectArchives, bookId),
    restoreProjectArchive: (request) => ipcRenderer.invoke(AGENT_IPC_CHANNELS.restoreProjectArchive, request),
