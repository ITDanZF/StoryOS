...
import { DEVELOPER_DATABASE_CHANNEL, type DeveloperDatabaseApi } from "../shared/developerDatabase.ts";
...
const api: DeveloperDatabaseApi = {
  ...
  describeTable: (id, table) => ipcRenderer.invoke(DEVELOPER_DATABASE_CHANNEL, "describeTable", id, table),
