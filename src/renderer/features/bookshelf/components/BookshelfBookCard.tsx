...
export default function BookshelfBookCard({
  ...
  if (book.availability === "unavailable") {
    return <article className="shelf-card shelf-card-unavailable">
      <div className="grid place-items-center bg-warning-surface text-warning-text"><AlertTriangle size={28} /></div>
      <div className="shelf-card-content">
        <span className="text-[13px] leading-5 text-warning-text">{BOOK_STORAGE_LABELS[book.storageState]}</span>
