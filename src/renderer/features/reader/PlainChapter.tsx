import { readerThemeStyle } from "./readerThemes.ts";
...
export default function PlainChapter({ location, size, preferences, onPosition }: {
  ...
  return <div className="reader-book-dom reader-plain-scroll" ref={scroll} aria-label="可选择文字的连续章节" style={{ ...readerThemeStyle(preferences.theme), width: size.width, maxHeight: size.height,
