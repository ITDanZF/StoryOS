...
export default function ProjectConversationSwitcher({
  ...
  return (
    <div className="relative min-w-0" ref={rootRef}>
      <button
        className={cn(
          "grid min-w-0 gap-0.5 rounded-lg border-0 bg-transparent px-2 py-1 text-left transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-border",
          open && "bg-muted",
        )}
        type="button"
      ...
      <section
        className={cn(
          "absolute left-0 top-[calc(100%+8px)] z-50 w-[min(320px,calc(100vw-2rem))] overflow-hidden rounded-xl border border-border bg-card shadow-[0_18px_46px_rgba(30,28,20,0.16)] transition-all",
          open
          ...
          {snapshot?.threads.map((thread) => {
            ...
            return (
              ...
              >
                ...
                <button
                  className="grid min-w-0 gap-0.5 rounded-md border-0 bg-transparent px-1 py-1 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-border"
                  type="button"
                ...
                <button
                  className={cn(
                    "grid size-7 place-items-center rounded-md border-0 bg-transparent text-text-subtle opacity-0 transition hover:bg-danger-surface hover:text-danger-text focus-visible:opacity-100 group-hover/thread:opacity-100",
                    active && "opacity-60",
                  )}
                  type="button"
                  disabled={running}
